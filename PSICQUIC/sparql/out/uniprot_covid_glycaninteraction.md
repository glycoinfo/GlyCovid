...
SELECT ?child_taxon ?child_taxon_name ?interactor ?other_interactor_chebi_uri ?glytoucan_uri
WHERE {
  ...
  SERVICE <https://sparql.uniprot.org> {
    ...
    optional {
        ?child_taxon :scientificName ? ?child_taxon_name
      }
    ...
    "bindings": [
      {
        ...
        "glytoucan_uri": {
          "type": "uri",
          "value": "http://rdf.glycoinfo.org/glycan/G81533KY"
        }
      },
      {
        "child_taxon": {
